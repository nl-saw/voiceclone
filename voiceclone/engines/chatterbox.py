...
def ensure_installed(logline=print) -> None:
    ...
    # it rebuilds the venv into the project's own cache dir.
    ...
    # marker claiming success while packages are still missing — the next run
    # would then short-circuit into "Already installed" with a broken engine.
